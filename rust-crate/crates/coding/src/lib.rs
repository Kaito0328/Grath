...
pub mod types;
pub mod prelude {
    pub use crate::error::{CodingError, Result as CodingResult};
}

pub use api::{CodingApi, DtoFixtureApi, DtoLabel, DtoPoint};
pub use bch::BCHCode;
pub use code_utils::*;
...
pub type Poly<F> = polynomial::core::Polynomial<F>;
