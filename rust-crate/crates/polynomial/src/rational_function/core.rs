...
crate::impl_ops_by_ref_variants!(RationalFunction<F>, Add, add, algebraic::traits::Field);
crate::impl_ops_by_ref_variants!(RationalFunction<F>, Sub, sub, algebraic::traits::Field);
crate::impl_ops_by_ref_variants!(RationalFunction<F>, Mul, mul, algebraic::traits::Field);
crate::impl_ops_by_ref_variants!(RationalFunction<F>, Div, div, algebraic::traits::Field);

// -------- Display (generic over field F) --------
impl<F> fmt::Display for RationalFunction<F>
where
    F: algebraic::traits::Field + fmt::Display + Clone + PartialEq,
{
