...
impl DiscreteTransferFunction {
    ...
    pub fn bode_svg_simple_string(&self, width: u32, height: u32, n_points: usize) -> String {
    ...
    pub fn nyquist_svg_simple_string(&self, width: u32, height: u32, n_points: usize) -> String {
        let opts = crate::plot::DiscreteNyquistOptions {
            n_points: n_points.max(2),
            legend: false,
            ..Default::default()
...
impl ContinuousTransferFunction {
    ...
    pub fn nyquist_svg_string(
        ...
        let mut buf: Vec<u8> = Vec::with_capacity(32 * 1024);
        let _ =
            write_nyquist_svg_continuous_multi(&[(self, "G(s)")], &mut buf, width, height, opts);
        String::from_utf8(buf).unwrap_or_default()
    }
