...
pub fn run_dynamic_test(func_key: &str, inputs: &[String]) -> std::result::Result<String, String> {
    match func_key {
        ...
        "CodingApi::linear_code_gf5_third" => {
            ...
            let result =
                CodingApi::linear_code_gf5_third(arg0, arg1).map_err(|e| format!("{:?}", e))?;
            Ok(result.to_string())
        }
        "DtoFixtureApi::batch" => {
            let arg0: Vec<DtoPoint> = serde_json::from_str(&inputs[0])
                .map_err(|e| format!("Parse DTO arg0 error: {}", e))?;

            let result = DtoFixtureApi::batch(arg0);
            Ok(serde_json::to_string(&result).map_err(|e| e.to_string())?)
        }
        "DtoFixtureApi::maybe" => {
            let arg0: Option<DtoPoint> = serde_json::from_str(&inputs[0])
                .map_err(|e| format!("Parse DTO arg0 error: {}", e))?;
        ...
        "DtoFixtureApi::pair" => {
            let arg0: (DtoPoint, i32) = serde_json::from_str(&inputs[0])
                .map_err(|e| format!("Parse DTO arg0 error: {}", e))?;
        ...
        "DtoFixtureApi::fixed" => {
            let arg0: [DtoPoint; 2] = serde_json::from_str(&inputs[0])
                .map_err(|e| format!("Parse DTO arg0 error: {}", e))?;
        ...
        "DtoFixtureApi::by_name" => {
            let arg0: BTreeMap<String, DtoPoint> = serde_json::from_str(&inputs[0])
                .map_err(|e| format!("Parse DTO arg0 error: {}", e))?;
        ...
        "DtoFixtureApi::label" => {
            let arg0: DtoLabel = serde_json::from_str(&inputs[0])
                .map_err(|e| format!("Parse DTO arg0 error: {}", e))?;
        ...
        "DtoFixtureApi::checked" => {
            let arg0: DtoPoint = serde_json::from_str(&inputs[0])
                .map_err(|e| format!("Parse DTO arg0 error: {}", e))?;
