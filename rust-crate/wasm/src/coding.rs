...
impl WasmCodingApi {
    pub fn inner(&self) -> &CodingApi { &self.0 }
}
...
impl WasmDtoFixtureApi {
    pub fn inner(&self) -> &DtoFixtureApi { &self.0 }
}
...
impl WasmReedSolomon {
    pub fn inner(&self) -> &ReedSolomon { &self.0 }
}
...
impl WasmHamming74 {
    pub fn inner(&self) -> &Hamming74 { &self.0 }
}
...
impl WasmBCHCode {
    pub fn inner(&self) -> &BCHCode { &self.0 }
}
...
impl WasmCodingApi {
    ...
    pub fn reed_solomon_encode(k: usize, n: usize, msg: Vec<u8>, primitive_px: Vec<u8>) -> std::result::Result<Vec<u8>, JsError> {
        CodingApi::reed_solomon_encode(k, n, msg, primitive_px).map_err(|e| JsError::new(&format!("{:?}", e)))
    }
    pub fn reed_solomon_decode_bm(k: usize, n: usize, recv: Vec<u8>, primitive_px: Vec<u8>) -> std::result::Result<Vec<u8>, JsError> {
        CodingApi::reed_solomon_decode_bm(k, n, recv, primitive_px).map_err(|e| JsError::new(&format!("{:?}", e)))
    }
    ...
    pub fn bch_encode_auto(m: usize, t: usize, msg_bits: Vec<u8>) -> std::result::Result<Vec<u8>, JsError> {
        CodingApi::bch_encode_auto(m, t, msg_bits).map_err(|e| JsError::new(&format!("{:?}", e)))
    }
    pub fn bch_decode_bm(m: usize, t: usize, recv_bits: Vec<u8>) -> std::result::Result<Vec<u8>, JsError> {
    ...
    pub fn bch_encode(n: usize, g_bits: Vec<u8>, msg_bits: Vec<u8>) -> std::result::Result<Vec<u8>, JsError> {
        CodingApi::bch_encode(n, g_bits, msg_bits).map_err(|e| JsError::new(&format!("{:?}", e)))
    }
    pub fn bch_decode_bm_with_g(n: usize, g_bits: Vec<u8>, recv_bits: Vec<u8>) -> std::result::Result<Vec<u8>, JsError> {
        CodingApi::bch_decode_bm_with_g(n, g_bits, recv_bits).map_err(|e| JsError::new(&format!("{:?}", e)))
    }
    ...
    pub fn cyclic_encode(n: usize, g_bits: Vec<u8>, msg_bits: Vec<u8>) -> std::result::Result<Vec<u8>, JsError> {
        CodingApi::cyclic_encode(n, g_bits, msg_bits).map_err(|e| JsError::new(&format!("{:?}", e)))
    }
    pub fn cyclic_decode_lut(n: usize, g_bits: Vec<u8>, recv_bits: Vec<u8>) -> std::result::Result<Vec<u8>, JsError> {
        CodingApi::cyclic_decode_lut(n, g_bits, recv_bits).map_err(|e| JsError::new(&format!("{:?}", e)))
    }
    pub fn gf2_cyclic_generator_matrix(n: usize, g_bits: Vec<u8>) -> std::result::Result<String, JsError> {
        CodingApi::gf2_cyclic_generator_matrix(n, g_bits).map_err(|e| JsError::new(&format!("{:?}", e)))
    }
    pub fn gf2_cyclic_parity_check_matrix(n: usize, g_bits: Vec<u8>) -> std::result::Result<String, JsError> {
        CodingApi::gf2_cyclic_parity_check_matrix(n, g_bits).map_err(|e| JsError::new(&format!("{:?}", e)))
    }
    pub fn gf2_parity_check_from_generator_matrix(g_csv: String) -> std::result::Result<String, JsError> {
        CodingApi::gf2_parity_check_from_generator_matrix(g_csv).map_err(|e| JsError::new(&format!("{:?}", e)))
    }
...
pub fn dto_point_new(x: f64, y: f64) -> std::result::Result<JsValue, JsError> {
    serde_wasm_bindgen::to_value(&DtoFixtureApi::new(x, y)).map_err(|e| JsError::new(&e.to_string()))
}

#[wasm_bindgen]
pub fn dto_point_translate(point_value: JsValue, dx: f64, dy: f64) -> std::result::Result<JsValue, JsError> {
    let point: DtoPoint = serde_wasm_bindgen::from_value(point_value).map_err(|e| JsError::new(&e.to_string()))?;
    serde_wasm_bindgen::to_value(&DtoFixtureApi::translate(point, dx, dy)).map_err(|e| JsError::new(&e.to_string()))
}

#[wasm_bindgen]
pub fn dto_point_batch(points_value: JsValue) -> std::result::Result<JsValue, JsError> {
    let points: Vec<DtoPoint> = serde_wasm_bindgen::from_value(points_value).map_err(|e| JsError::new(&e.to_string()))?;
    serde_wasm_bindgen::to_value(&DtoFixtureApi::batch(points)).map_err(|e| JsError::new(&e.to_string()))
}

#[wasm_bindgen]
pub fn dto_point_maybe(point_value: JsValue) -> std::result::Result<JsValue, JsError> {
    let point: Option<DtoPoint> = serde_wasm_bindgen::from_value(point_value).map_err(|e| JsError::new(&e.to_string()))?;
    serde_wasm_bindgen::to_value(&DtoFixtureApi::maybe(point)).map_err(|e| JsError::new(&e.to_string()))
}

#[wasm_bindgen]
pub fn dto_point_pair(value_value: JsValue) -> std::result::Result<JsValue, JsError> {
    let value: (DtoPoint, i32) = serde_wasm_bindgen::from_value(value_value).map_err(|e| JsError::new(&e.to_string()))?;
    serde_wasm_bindgen::to_value(&DtoFixtureApi::pair(value)).map_err(|e| JsError::new(&e.to_string()))
}

#[wasm_bindgen]
pub fn dto_point_fixed(values_value: JsValue) -> std::result::Result<JsValue, JsError> {
    let values: [DtoPoint; 2] = serde_wasm_bindgen::from_value(values_value).map_err(|e| JsError::new(&e.to_string()))?;
    serde_wasm_bindgen::to_value(&DtoFixtureApi::fixed(values)).map_err(|e| JsError::new(&e.to_string()))
}

#[wasm_bindgen]
pub fn dto_point_by_name(values_value: JsValue) -> std::result::Result<JsValue, JsError> {
    let values: BTreeMap<String, DtoPoint> = serde_wasm_bindgen::from_value(values_value).map_err(|e| JsError::new(&e.to_string()))?;
    serde_wasm_bindgen::to_value(&DtoFixtureApi::by_name(values)).map_err(|e| JsError::new(&e.to_string()))
}

#[wasm_bindgen]
pub fn dto_point_label(value_value: JsValue) -> std::result::Result<JsValue, JsError> {
    let value: DtoLabel = serde_wasm_bindgen::from_value(value_value).map_err(|e| JsError::new(&e.to_string()))?;
    serde_wasm_bindgen::to_value(&DtoFixtureApi::label(value)).map_err(|e| JsError::new(&e.to_string()))
}
